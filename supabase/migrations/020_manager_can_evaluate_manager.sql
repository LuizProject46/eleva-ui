-- Migration 020: Manager can evaluate other managers (manager_to_employee and direct_feedback).
-- Run after 019.
...
BEGIN
  ...
  -- Gestor pode avaliar: colaboradores (employee), outros gestores (manager), RH (hr).
